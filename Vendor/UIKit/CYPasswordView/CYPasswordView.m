...
- (UIControl *)coverView
{
    if (_coverView == nil)
    {
        ...
        [_coverView setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:0.5]];
...
- (CYPasswordInputView *)passwordInputView
{
    if (_passwordInputView == nil)
    {
        ...
        [_passwordInputView addGestureRecognizer:[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapGusture:)]];
    }
    return _passwordInputView;
}

- (void)tapGusture:(UITapGestureRecognizer *)tap {
