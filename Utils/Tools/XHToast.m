...
//Toast背景颜色
#define ToastBackgroundColor [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.75]
...
- (id)initWithText:(NSString *)text{
    if (self = [super init]) {
        ...
        CGRect rect=[text boundingRectWithSize:CGSizeMake([UIScreen mainScreen].bounds.size.width-20-10,CGFLOAT_MAX) options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:dict context:nil];
        UILabel *textLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 5,rect.size.width , rect.size.height)];
        ...
        _contentView = [[UIButton alloc] initWithFrame:CGRectMake(10, 0, [UIScreen mainScreen].bounds.size.width-20, textLabel.frame.size.height+10)];
