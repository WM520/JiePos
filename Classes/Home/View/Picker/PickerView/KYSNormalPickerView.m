...
- (NSInteger)KYSPickerView:(KYSPickerView *)pickerView selectedIndexInComponent:(NSInteger)component{
    //JPLog(@"默认选中哪一项 component：%ld,selected：%ld",(long)component,(long)[self.selectedIndexInComponents[component] integerValue]);
