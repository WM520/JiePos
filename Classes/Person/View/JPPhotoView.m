...
//        self.takePhotoButton.layer.mask = maskLayer;
        ...
        self.takePhotoButton.titleLabel.font = [UIFont systemFontOfSize:JPRealValue(26)];
        [self.takePhotoButton setTitle:@"\t\t\t拍照" forState:UIControlStateNormal];
        [self.takePhotoButton setTitleColor:[UIColor colorWithHexString:@"888888"] forState:UIControlStateNormal];
//        [self.takePhotoButton setImage:[UIImage imageNamed:@"jp_person_photoCamera"] forState:UIControlStateNormal];
    ...
    if (!self.accessAlbumButton) {
        ...
        self.accessAlbumButton.titleLabel.font = [UIFont systemFontOfSize:JPRealValue(26)];
        [self.accessAlbumButton setTitle:@"\t\t\t从相册选择" forState:UIControlStateNormal];
        [self.accessAlbumButton setTitleColor:[UIColor colorWithHexString:@"888888"] forState:UIControlStateNormal];
