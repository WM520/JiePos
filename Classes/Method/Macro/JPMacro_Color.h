...
//  线的颜色
#define JP_LineColor [UIColor colorWithHexString:@"dddddd"]
//  提示文本颜色
#define JP_NoticeText_Color [UIColor colorWithHexString:@"888888"]
//  文字色
#define JP_Content_Color [UIColor colorWithHexString:@"555555"]
#define JP_Dark_Color [UIColor colorWithHexString:@"333333"]
//  背景色
#define JP_viewBackgroundColor [UIColor colorWithHexString:@"fafbff"]
//  边框线颜色
