...
+ (NSString *)random {
    NSString *dateString = [NSDate stringFromDate:[NSDate date] withFormat:@"yyyyMMddHHmmssSSS"];
    NSString *randomString = [NSString stringWithFormat:@"%04d", arc4random() % 10000];
